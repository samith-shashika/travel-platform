  ...
  useEffect(() => {
    const fetchListing = async () => {
      try {
        ...
        setForm({ title: l.title, location: l.location, description: l.description, price: l.price || "" });
        setCurrentImage(l.imageUrl);
        setImagePreview(l.imageUrl);
      } catch {
        router.push("/feed");
      } finally {
        setFetching(false);
      ...
      <div className="max-w-2xl mx-auto px-4 py-10">
        <div className="bg-white rounded-3xl shadow-sm p-6 md:p-10">
          ...
          <form onSubmit={submit} className="space-y-6">
            {/* Image Upload */}
            <div>
              <label className="block text-sm font-bold text-gray-700 mb-2">Experience Image</label>
              <div
                onClick={() => document.getElementById("imageInput").click()}
                className="relative border-2 border-dashed border-amber-400 rounded-2xl overflow-hidden cursor-pointer h-56"
              >
            ...
            {/* Location */}
            <div>
              <label className="block text-sm font-bold text-gray-700 mb-2">Location <span className="text-red-400">*</span></label>
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleChange} placeholder="Describe your experience..." required rows={5}
            ...
            {/* Price */}
            <div>
              <label className="block text-sm font-bold text-gray-700 mb-2">Price <span className="text-gray-400 font-normal">(optional)</span></label>
              <div className="relative">
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className="flex-1 bg-amber-400 hover:bg-amber-300 disabled:opacity-50 text-black font-black py-4 rounded-2xl transition-colors text-base"
              >
